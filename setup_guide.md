...
This is the actual app — the screen a hospital coordinator would use. You should see a page called "New Assessment." This address is the same either way, Docker or manual.
